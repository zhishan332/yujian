...
//import com.yujian.wq.spider.wwwnvshenscom.NvshensImgSpider;
...
// * @since 2018/1/8
// */
//@PipelineName("ImgDownPipeline")
//public class ImgDownPipeline implements Pipeline<IndexSpider> {
//
...
//
//    @Override
//    public void process(IndexSpider bean) {
//
...
//            }
//
//            int nextId = Integer.parseInt(bean.getId()) + 1;
//            String nextUrl = "http://jandan.net/ooxx/page-" + nextId;
